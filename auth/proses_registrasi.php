...
if ($sql) {
    ...
    ';
    header('location: ../auth/index.php?home'); // Arahkan ke halaman login setelah registrasi berhasil
} else {
    $_SESSION['pesan'] = '
    ...
    ';
    header('location: register.php'); // Kembali ke halaman registrasi jika gagal
}
?>
