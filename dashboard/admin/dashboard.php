...
$belumbayar = mysqli_query($kon, "SELECT COUNT(*) AS belum_bayar FROM tb_order WHERE status_order = 'diproses' AND aTanggal_order = '$date' ");
...
<div class="container mt-3">
	<div class="card bg-success text-white border-success mb-3">
  		<div class="row no-gutters">
    		<div class="col-md-1">
			<img src="assets/image/profile.png" class="p-3 rounded-circle" alt="foto" width="100" height="100" 
